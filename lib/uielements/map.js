          ...
          self.__super(parentElement, function(){
            ...
            if (self.webGLReady){
              ...
              Joshfire.require(['joshfire/vendor/webglearth'], function(){
                ...
                console.warn('map insert', options)
          ...
          **/
            ...
            **/
            moveToLocationWebGL:function(location, options,callback){
                /** ,nothing here yet **/
                //this.moveToLocationClassic(location, options, callback);
                ...
                //console.log("lat " + current_position[0].toString() + " " + lat.toString() );
                //console.log("lng " + current_position[1].toString() + " " + lng.toString() );
                if (current_position[0] === lat && 
                    current_position[1] === lng) {
                    callback();
                    return;
                }
