          ...
          **/
            ...
            **/
            moveToLocationWebGL:function(location, options,callback){
                ...
                options = _.extend({}, options, { maxAscent: 0.3, animationDuration: 4000, altitude: 150000});
                ...
                this.map.flyTo(lat, lng, options.maxAscent, duration, options.altitude);
                setTimeout(function() {
                    console.log('flyout timeout')
                    callback();
                }, duration);
            },
          /**
